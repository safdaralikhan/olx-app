    ...
    <div class="container">
        <div class="col-md-7 mx-auto mybred">
            ...
            <div class="mb-3 col-md-12">
                ...
                <input type="text" name="title" class="form-control" width="60%" id="formGroupExampleInput" placeholder="">
            ...
            <div>
                <span>Type</span>
                <br>
                <span><label for="">Accessories for Man</label> <input type="radio" value="Accessories for Man" name="type" id=""></span>
                <span><label for="">Accessories for Woman</label> <input type="radio" value="Accessories for Woman" name="type" id=""></span>
            </div>

            <div class="mb-4 mt-4">
                <span>Condition</span> <br>
                <span><label for="">New</label> <input type="radio" value="New" name="condition" id=""></span>
                <span><label for="">Used</label> <input type="radio" value="Used" name="condition" id=""></span>
