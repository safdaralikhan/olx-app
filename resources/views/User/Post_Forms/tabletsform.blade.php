        ...
        <div class="col-md-7 mx-auto mybred">
            ...
            <div class="mb-4 mt-4">
                ...
                <div class="radio-toolbar">
                    <input type="radio" id="radioApple" name="type_of_ad" value="Apple" >
                    <label for="radioApple">Apple</label>
                    

                    <input type="radio" id="radioBanana" name="type_of_ad" value="Dany Tabs">
                    <label for="radioBanana">Dany Tabs</label>

                    <input type="radio" id="radioTabs" name="type_of_ad" value="Q Tabs">
                    <label for="radioTabs">Q Tabs</label>

                    <input type="radio" id="radioSamsung" name="type_of_ad" value="Samsung">
                    <label for="radioSamsung">Samsung</label>
                    <input type="radio" id="radioTablets" name="type_of_ad" value="Other Tablets">
                    <label for="radioTablets">Other Tablets</label>
