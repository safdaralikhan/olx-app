        ...
        <div class="col-md-7 mx-auto mybred">
            ...
            <div class="mb-4 mt-4">
                ...
                <div class="radio-toolbar">
                    <input type="radio" id="radioMobile" name="type_of_ad" value="Mobile" >
                    <label for="radioMobile">Mobile</label>
                    

                    <input type="radio" id="radioTablet" name="type_of_ad" value="Tablet">
                    <label for="radioTablet">Tablet</label>
