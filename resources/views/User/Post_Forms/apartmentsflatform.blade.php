    ...
    <div class="container">
        <div class="col-md-7 mx-auto mybred">
            ...
            <div class="form-floating mb-3 mt-4 col-md-12">
                ...
                <textarea class="form-control" name="discription" placeholder="" id="floatingTextarea2" style="height: 100px"></textarea>
                <span class="dscp">
            ...
            <div>
                    ...
                    <div class="radio-toolbar">
                        <input type="radio" id="radioUnfurnished" name="type_of_cond" value="Unfurnished" >
                        <label for="radioUnfurnished">Unfurnished</label>
                        
    
                        <input type="radio" id="radioFurnished" name="type_of_cond" value="Furnished">
                        <label for="radioFurnished">Furnished</label>
            ...
            <div class="mb-3 col-md-12">
                ...
                <input type="number" name="area" class="form-control" width="60%" id="formGroupExampleInput"
            ...
            <div class="mb-4 mt-4">
                ...
                <div class="radio-toolbar">
                    <input type="radio" id="radioKanal" name="type_of_ad" value="Kanal" >
                    <label for="radioKanal">Kanal</label>
                    

                    <input type="radio" id="radioMarla" name="type_of_ad" value="Marla">
                    <label for="radioMarla">Marla</label>

                    <input type="radio" id="radioSquareFeet" name="type_of_ad" value="Square Feet">
                    <label for="radioSquareFeet">Square Feet</label>

                    <input type="radio" id="radioSquareMeter" name="type_of_ad" value="Square Meter">
                    <label for="radioSquareMeter">Square Meter</label>

                    <input type="radio" id="radioSquareYard" name="type_of_ad" value="Square Yard">
                    <label for="radioSquareYard">Square Yard</label>
            ...
            <div class="col-md-12">
                ...
                <div class="input-group flex-nowrap ">
                    ...
                    <input type="text" name="price" class="form-control" placeholder="" aria-label="Username"
       ...
       <input type="file" name='img6' onchange='readImage(this)' required/>
            ...
            <div class="col-md-12 p-4 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input class="form-control" name="postman_name" type="text" class="form-control" placeholder=""
            ...
            <div>
                ...
                <div class="form-check form-switch check">
                    <input class="form-check-input " type="checkbox" value="1" name="is_mobile" id="flexSwitchCheckChecked" checked>
