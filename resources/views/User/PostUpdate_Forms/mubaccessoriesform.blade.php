...
<body>
    ...
    <div class="container">
        <div class="col-md-7 mx-auto mybred">
            ...
            <div class="mb-4 mt-4">
                <span>type*</span> <br>
                <span><label for="">Mobile</label> <input type="radio"  {{($data->type == 'Mobile') ? 'checked' : ''}} value="Mobile" name="type" id=""></span>
                <span><label for="">Tablet</label> <input type="radio" {{($data->type == 'Tablet') ? 'checked' : ''}} value="Tablet" name="type" id=""></span>
            ...
            <div class="col-md-12 p-4 ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <img class="img" src="{{asset('User/images/profile img.png')}}" alt=""> <br>
                    </div>
                    <div class="col-md-12">
