        ...
        <div class="col-md-7 mx-auto mybred">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> Apartments & Flats
            ...
            <div class="form-floating mb-3 mt-4 col-md-12">
                ...
                <textarea class="form-control" name="discription" placeholder="" id="floatingTextarea2" style="height: 100px">{{$data->description}}</textarea>
                <span class="dscp">
            ...
            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Floor Level</label>
                <select class="custom-select" name="floor_level" required>
                    <option value="">Select..</option>
                    <option value="1"  {{($data->floor_level == '1') ? 'chacked' : ''}}>1</option>
                    <option value="2"  {{($data->floor_level == '2') ? 'chacked' : ''}}>2</option>
                    <option value="3"  {{($data->floor_level == '3') ? 'chacked' : ''}}>3
                    <option>
                    <option value="4"  {{($data->floor_level == '4') ? 'chacked' : ''}}>4</option>
                    <option value="5"  {{($data->floor_level == '5') ? 'chacked' : ''}}>5</option>
                    <option value="6+"  {{($data->floor_level == '6+') ? 'chacked' : ''}}>6+</option>
                    <option value="Ground" {{($data->floor_level == 'Ground') ? 'chacked' : ''}}>Ground </option>
            ...
            <div class="mb-3 col-md-12">
                ...
                <input type="number" name="area" value="{{$data->area}}" class="form-control" width="60%" id="formGroupExampleInput"
            ...
            <div class="col-md-12">
                ...
                <div class="input-group flex-nowrap ">
                    ...
                    <input type="text" name="price" value="{{$data->price}}" class="form-control" placeholder="" aria-label="Username"
           ...
           <input type="file" name='img11' onchange='readImage(this)' />
            ...
            <div class="mb-3">
                ...
                <select class="custom-select" name="state" required>
                    <option value="">Select..</option>
                    <option value="sindh" {{($data->state == 'sindh') ? 'checked' : ''}} > Sindh</option>
                    <option value="punjab" {{($data->state == 'punjab') ? 'checked' : ''}}>Punjab</option>
                    <option value="balochistan" {{($data->state == 'balochistan') ? 'checked' : ''}}>Balochistan</option>
                    <option value="kpk" {{($data->state == 'kpk') ? 'checked' : ''}}>KPK</option>
            ...
            <div class="mb-3">
                ...
                <select class="custom-select" name="city" required>
                    <option value="">Select..</option>
                    <option value="karachi" {{($data->city == 'karachi') ? 'checked' : ''}}>Karachi</option>
                    <option value="lahore"{{($data->city == 'lahore') ? 'checked' : ''}}>lahore</option>
                    <option value="islambad"{{($data->city == 'islambad') ? 'checked' : ''}}>Islamabad</option>
                    <option value="multan"{{($data->city == 'multan') ? 'checked' : ''}}>Multan</option>
            ...
            <div>
                ...
                <div class="form-check form-switch check">
                    <input class="form-check-input " type="checkbox" value="1" {{($data->isPhone == '1') ? 'checked' : ''}} name="is_mobile" id="flexSwitchCheckChecked" checked>
