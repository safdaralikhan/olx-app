        ...
        <div class="col-md-7 mx-auto mybred">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Tablets
            ...
            <div class="mb-4 mt-4">
                <span>type*</span> <br>
                <span><label for="">Apple</label> <input type="radio" value="Apple"  {{($data->type == 'Apple') ? 'checked' : ''}} name="type" id=""></span>
                <span><label for="">Dany Tabs</label> <input type="radio" value="Dany Tabs"  {{($data->type == 'Dany Tabs') ? 'checked' : ''}} name="type" id=""></span>
                <span><label for="">Q Tabs</label> <input type="radio" value="Q Tabs"  {{($data->type == 'Q Tabs') ? 'checked' : ''}} name="type" id=""></span>
                <span><label for="">Samsung</label> <input type="radio" value="Samsung"  {{($data->type == 'Samsung') ? 'checked' : ''}} name="type" id=""></span>
                <span><label for="">Other Tablets</label> <input type="radio" value="Other Tablets"  {{($data->type == 'Other Tablets') ? 'checked' : ''}} name="type" id=""></span>
           ...
           <input type="file" name='img11' onchange='readImage(this)' />
            ...
            <div>
                ...
                <div class="form-check form-switch check">
                    <input class="form-check-input " type="checkbox" name="is_mobile"    {{($data->isPhone == '1') ? 'chacked' : ''}} value="1" id="flexSwitchCheckChecked" checked>
